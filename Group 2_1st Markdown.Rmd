...
- Allen Abel
   ...
   First of all it can help the person improve their analytical skills which can be useful in some field. It can also be used to make informed decision, backed or disproved arguments or optimization that will improve something.But the most important thing on why we need to study and analyze data is that data when can be used to influenced a lot of things from a regular person everyday activities to that of a country's economy and government.
